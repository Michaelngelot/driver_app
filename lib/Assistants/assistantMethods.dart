...
class AssistantMethods
{
  static Future<DirectionDetails?> obtainPlaceDirectionDetails(LatLng initialPosition, LatLng finalPosition) async
  {
    ...
    DirectionDetails directionDetails = DirectionDetails(durationValue: 0, distanceText: '', durationText: '', encodedPoints: '', distanceValue: 0,);
  ...
  static int calculateFares(DirectionDetails directionDetails)
  {
    ...
    else if(rideType == "truck-go")
    {
      return totalFareAmount.truncate();
    }
    else if(rideType == "small truck")
    {
      double result = (totalFareAmount.truncate()) / 2.0;
      return result.truncate();
    }
